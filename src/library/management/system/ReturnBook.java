...
public class ReturnBook extends JFrame implements ActionListener{
    ...
    public ReturnBook() {
        ...
        Image i3 = i1.getImage().getScaledInstance(617, 363,Image.SCALE_DEFAULT);
