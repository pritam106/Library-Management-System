...
public class IssueBook extends JFrame implements ActionListener{
	...
	t8.setForeground(new Color(0,0,0));
        t8.setBackground(new Color(255,255,153));
